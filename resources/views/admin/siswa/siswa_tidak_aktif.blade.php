...
<div class="page-header row no-gutters py-4">
  <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
    <h3 class="page-title">List Siswa Tidak Aktif</h3>
  </div>
</div>
<div class="row">
  <div class="col">
      ...
      <div class="card-header border-bottom">
		...
		<div class="col-md-6 input-group mb-1 px-0">
	        ...
	        <div class="input-group-append ">
				...
				<a title="Download" href="{{ route('export.tidak_aktif',['type'=>'xls']) }}" class="button button-primary" style="margin:2px;" target="_blank"><i class="fa fa-download"></i></a>
			</div>
    	</div>
		{!! Form::close() !!}
        ...
        <table class="table table table-bordered table-striped table-hover table-condensed tfix mb-1" style="font-family: Arial; font-size: 13px">
          <thead class="bg-light">
            <tr>
              ...
              <th scope="col" class="border-0" style="width:150px;">Actions</th>
            </tr>
          </thead>
          <tstatus>
