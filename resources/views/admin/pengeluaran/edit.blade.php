  ...
  <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div class="card-body">
        {!! Form::model($luaran,['method'=>'put', 'files'=> 'true', 'action'=>['admin\PengeluaranController@update',$luaran->id]]) !!}
          <table class="table table-striped table-hover">
          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-primary" style="width:50%">Sekolah</div>
                {{ Form::select('id_sekolah', $school, null,['class' => 'form-control', 'required', 'value'=>null]) }}
            </div>
          </tr>
          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-primary" style="width:50%">Kode Pengeluaran</div>
              {{ Form::text("kode_pengeluaran", null,['class' => 'form-control required', 'placeholder' => ' ']) }}
          ...
          <tr>
            <div class="col-md-4  input-group mb-1">
              ...
              {{ Form::text("asal_pengeluaran", null,['class' => 'form-control required', 'placeholder' => ' ']) }}
              <div class="input-group-append">
              </div>
            </div>
          </tr>
          <tr>
            <div class=" col-md-6 input-group mb-1">
              ...
              {{ Form::text("nama_pengeluaran", null,['class' => 'form-control required', 'placeholder' => ' ']) }}
              <div class="input-group-append">
              </div>
            </div>
          </tr>
          ...
          <tr>
            ...
            <div class="col-md-6 input-group mb-1" style="float: left;">
              ...
              {{ Form::text("no_giro", null,['class' => 'form-control required', 'placeholder' => ' ']) }}
              <div class="input-group-append">
              </div>
            </div>
          </tr>
