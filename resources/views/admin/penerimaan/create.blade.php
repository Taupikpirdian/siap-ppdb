  ...
  <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="card card-small mb-3">
		...
		{{ Form::open(array('url' => 'penerimaans/create', 'files' => true, 'method' => 'post')) }}
          <table class="table table-striped table-hover">

          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-primary" style="width:54%">Kode Penerimaan</div>
              {{ Form::text("kode_penerimaan", '',['class' => 'form-control required', 'placeholder' => ' ']) }}
          ...
          <tr>
            <div class="col-md-4  input-group mb-1">
              ...
              {{ Form::text("asal_penerimaan", '',['class' => 'form-control required', 'placeholder' => ' ']) }}
              <div class="input-group-append">
              </div>
            </div>
          </tr>
          <tr>
            <div class=" col-md-5 input-group mb-1">
              ...
              {{ Form::text("nama_penerimaan", '',['class' => 'form-control required', 'placeholder' => ' ']) }}
              <div class="input-group-append">
              </div>
            </div>
          </tr>
          <tr>
            <div class="col-md-5 input-group mb-1">
              ...
              {{ Form::select('id_sekolah', $sekolah, null,['class' => 'form-control', 'required', 'value'=>'']) }}
