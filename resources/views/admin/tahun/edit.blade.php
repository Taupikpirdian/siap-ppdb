  ...
  <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div class="card-body">
        {!! Form::model($year,['files'=>true,'method'=>'put','action'=>['admin\YearController@update',$year->id]]) !!}
          <table class="table table-striped table-hover">

          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-primary" style="width:50%">Tahun</div>
              {{ Form::text("tahun", null,['class' => 'form-control required', 'placeholder' => 'Masukan Tahun']) }}
