...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <h3 class="page-title">Input Data Program</h3>
    </div>
  </div>
  <!-- End Page Header -->
  <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div class="card-body">
          {{ Form::open(array('url' => 'programs/create', 'files' => true, 'method' => 'post')) }}
          <table class="table table-striped table-hover">

          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-primary" style="width:50%">Program</div>
              {{ Form::text("nama", '',['class' => 'form-control required', 'placeholder' => 'Masukan Program']) }}
