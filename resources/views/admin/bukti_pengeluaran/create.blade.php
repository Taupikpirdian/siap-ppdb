...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <h3 class="page-title">Input Bukti Pengeluaran</h3>
    </div>
  </div>
  <!-- End Page Header -->
  <div class="row">
	...
	{{ Form::open(array('url' => 'buktipengeluaran/create', 'files' => true, 'method' => 'post', 'class' => 'save_form')) }}
          <table class="table table-striped table-hover">

          <tr>
            <div class="col-md-4 input-group mb-1">
              <div class="button button-white" style="width:50%">Kode Pengeluaran</div>
              {{ Form::select('id_pengeluaran', $kode_pengeluarans, 'null',['class' => 'form-control id_pengeluaran', 'required', 'value'=>'']) }}
          ...
          <tr>
            <div class="col-md-4  input-group mb-1">
              <div class="button button-white" style="width:50%">Jumlah Pengeluaran</div>
              {{ Form::text("jumlah_pengeluaran", '',['class' => 'form-control required jumlah_pengeluaran', 'placeholder' => ' ']) }}
              <div class="input-group-append">
...
<script type="text/javascript">
  ...
  $('.id_pengeluaran').on('change',function(e){
    var id_pengeluaran = e.target.value;
    
    $.get('/ajax-get-id-pengeluaran?id_pengeluaran='+id_pengeluaran, function(data){
        max_input = data.jumlah;
        console.log(max_input);
        $(".jumlah_pengeluaran").prop('disabled', false);
      });
